            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-container">
                        <form action="notesprocess.jsp" >
                            <div class="form-group">
                                <input type="textarea"  name="note" class="form-control-input" id="tarea">
                                <label class="label-control" for="tarea">Notes</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            
                            <div class="form-group">
                                <button type="submit" class="form-control-submit-button">ADD NOTES</button>
                            </div>
