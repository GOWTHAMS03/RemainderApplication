					...
					<div class="container">
						<table>
							...
							<c:forEach items="${list}" var="u">
								<tr>
									<td><h6>
											<%out.print(email); %><h1></h1></td>
									<td><h6>
											<%out.print(pass); %><h6></td>

									<td><a href="retiriveimage.jsp?image=${u.getimage()}">Image</a></td>

									<td><a href="retrivenote.jsp?note=${u.getnote()}">Note</a></td>

									<td><a href="update.jsp?email=${u.getemail()}">Update</a></td>

									<td><a href="tretrivetime.jsp?time=${u.gettime()}">Alram</a></td>



									<td><a href="delete.jsp?email=${u.getemail()}">LOG OUT</a></td>
								</tr>
							</c:forEach>
						</table>
					</div>
